...
import { isValidEmail, isValidRepoFormat, isValidToken, parseRepo } from '@/shared/utils/validation';

export class SubscriptionValidator {
  assertRepoSlug(slug: string): void {
    if (!isValidRepoFormat(slug)) throw new ValidationError('Invalid repository format. Expected: owner/repo');
  }
